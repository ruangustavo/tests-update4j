...
<div class="row">
    <div class="col-md-12">
        <h4>
            <s:text name="telaCadastrarTarefa.titulo"/>
        </h4>
    </div>
</div>
...
<s:form action="/salvarTarefa" focusElement="data" cssClass="formulario" onsubmit="return false;">
    ...
    <div class="row">
        <s:hidden name="agendaTarefaForm.id"></s:hidden>
        <div class="col-md-6">
                        ...
                        <div class="radio">
                            ...
                            <s:if test="value == tipoTestePorTempo">
                                <input type="text" class="form-control" style="float: none; display: inline;"
                                       ...
                                       value="<s:property value="agendaTarefaForm.duracao"/>"
                ...
                <div class="col-md-12" style="clear: left; margin-bottom: 10px; margin-top: 10px; padding-left: 0px;">
                    ...
                    <div class='input-group date' id='dt'>
                        <input name="agendaTarefaForm.data" id="data"
                               value="<s:property value="agendaTarefaForm.data"/>" readonly="readonly" type="text"
                               size="16"
                               maxlength="16" style="cursor: pointer" data-date-format="DD/MM/YYYY HH:mm"
                               class="item-group date form-control"
                               onchange="propagaAlteracao('dt')"
                               onclick="exibirDtFrequenciaComponent()"/>
    ...
    <div class="row">
        <div class="col-md-12">
            <button onCLick="cadastrarTarefa(this.form)" class="btn btn-info">
...
<script>
    let evento = '<s:property value="agendaTarefaForm.tipoEvento"/>';

    if (evento.length > 0) {
        datahoraligar(evento);
    }

    let id = '<s:property value="agendaTarefaForm.id"/>';
